 ...
 * generated in the com.wp package. 
...
public class ObjectFactory {
    ...
    private final static QName _QueryWeather_QNAME = new QName("http://wp.com/", "queryWeather");
    private final static QName _QueryWeatherResponse_QNAME = new QName("http://wp.com/", "queryWeatherResponse");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: com.wp
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://wp.com/", name = "queryWeather")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://wp.com/", name = "queryWeatherResponse")
